 ...
 <header class="page-header header container-fluid" style = "padding-top: 90px; background-color :#B1B1B1 ">
        ...
        <div class="col-sm" style="left : 2em">
            ...
            <div class="caption">
                      ...
                      <p style="text-align: center; color: #07D1B1; padding-top: 40px;width:420px; height:100px; background-color : #353b48"><a href="articles_ajouter.php"> Ajouter un item</a></p>
               
            </div>
        </div>
        
        <div class="col-sm"style="left : 2em">
            <img src="img/Johny.jpg" width="420px" height="320" class="rounded" alt="Torque">
            <div class="caption">
                   
                   <p style="text-align: center; color: #07D1B1; padding-top: 40px;width:420px; height:100px; background-color : #353b48"><a href="creer_vendeur_ad.php">Ajouter un vendeur</a></p>
